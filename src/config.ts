...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    favicon: 'https://oimg.pages.dev/file/1769951947878_logo.png', // or https://example.com/favicon.svg
  },
  ...
  global: {
    ...
    moreLocales: ['zh', 'es', 'ja', 'zh-tw'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh', 'zh-tw']
    // post font style
  ...
  seo: {
    ...
    umamiAnalyticsID: '426e6918-343f-4ef2-9ba8-9b969b0aa3d8',
    // follow verification
    // https://follow.is/
    follow: {
      // feed ID
  ...
  preload: {
    ...
    customUmamiAnalyticsJS: 'https://umamiii.vercel.app/script.js',
  },
